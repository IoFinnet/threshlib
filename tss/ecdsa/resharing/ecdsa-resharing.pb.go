...
func (x *DGRound1Message) Reset() {
	*x = DGRound1Message{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ecdsa_resharing_proto_msgTypes[0]
...
func (*DGRound1Message) Descriptor() ([]byte, []int) {
	return file_ecdsa_resharing_proto_rawDescGZIP(), []int{0}
}
...
func (x *DGRound2Message1) Reset() {
	*x = DGRound2Message1{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ecdsa_resharing_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DGRound2Message1) Descriptor() ([]byte, []int) {
	return file_ecdsa_resharing_proto_rawDescGZIP(), []int{1}
}
...
func (x *DGRound2Message2) Reset() {
	*x = DGRound2Message2{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ecdsa_resharing_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DGRound2Message2) Descriptor() ([]byte, []int) {
	return file_ecdsa_resharing_proto_rawDescGZIP(), []int{2}
}
...
func (x *DGRound3Message1) Reset() {
	*x = DGRound3Message1{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ecdsa_resharing_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DGRound3Message1) Descriptor() ([]byte, []int) {
	return file_ecdsa_resharing_proto_rawDescGZIP(), []int{3}
}
...
func (x *DGRound3Message2) Reset() {
	*x = DGRound3Message2{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ecdsa_resharing_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DGRound3Message2) Descriptor() ([]byte, []int) {
	return file_ecdsa_resharing_proto_rawDescGZIP(), []int{4}
}
...
func (x *DGRound4Message) Reset() {
	*x = DGRound4Message{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ecdsa_resharing_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DGRound4Message) Descriptor() ([]byte, []int) {
	return file_ecdsa_resharing_proto_rawDescGZIP(), []int{5}
}

var File_ecdsa_resharing_proto protoreflect.FileDescriptor

var file_ecdsa_resharing_proto_rawDesc = []byte{
	,
	...
	,
	...
	0x52, 0x6f, 0x75, 0x6e, 0x64, 0x34, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x42, 0x15, 0x5a,
	0x13, 0x74, 0x73, 0x73, 0x2f, 0x65, 0x63, 0x64, 0x73, 0x61, 0x2f, 0x72, 0x65, 0x73, 0x68, 0x61,
	0x72, 0x69, 0x6e, 0x67, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_ecdsa_resharing_proto_rawDescOnce sync.Once
	file_ecdsa_resharing_proto_rawDescData = file_ecdsa_resharing_proto_rawDesc
)

func file_ecdsa_resharing_proto_rawDescGZIP() []byte {
	file_ecdsa_resharing_proto_rawDescOnce.Do(func() {
		file_ecdsa_resharing_proto_rawDescData = protoimpl.X.CompressGZIP(file_ecdsa_resharing_proto_rawDescData)
	})
	return file_ecdsa_resharing_proto_rawDescData
}

var file_ecdsa_resharing_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_ecdsa_resharing_proto_goTypes = []any{
...
var file_ecdsa_resharing_proto_depIdxs = []int32{
...
func init() { file_ecdsa_resharing_proto_init() }
func file_ecdsa_resharing_proto_init() {
	if File_ecdsa_resharing_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_ecdsa_resharing_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_ecdsa_resharing_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_ecdsa_resharing_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_ecdsa_resharing_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_ecdsa_resharing_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_ecdsa_resharing_proto_msgTypes[5].Exporter = func(v any, i int) any {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_ecdsa_resharing_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_ecdsa_resharing_proto_goTypes,
		DependencyIndexes: file_ecdsa_resharing_proto_depIdxs,
		MessageInfos:      file_ecdsa_resharing_proto_msgTypes,
	}.Build()
	File_ecdsa_resharing_proto = out.File
	file_ecdsa_resharing_proto_rawDesc = nil
	file_ecdsa_resharing_proto_goTypes = nil
	file_ecdsa_resharing_proto_depIdxs = nil
}
