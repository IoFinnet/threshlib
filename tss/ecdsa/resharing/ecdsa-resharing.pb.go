...
const file_ecdsa_resharing_proto_rawDesc = "" +
	"\n" +
	"\x15ecdsa-resharing.proto\x12\x1ebinance.tsslib.ecdsa.resharing\"t\n" +
	"\x0fDGRound1Message\x12\x1e\n" +
	"\vecdsa_pub_x\x18\x01 \x01(\fR\tecdsaPubX\x12\x1e\n" +
	"\vecdsa_pub_y\x18\x02 \x01(\fR\tecdsaPubY\x12!\n" +
	"\fv_commitment\x18\x03 \x01(\fR\vvCommitment\"\x91\x01\n" +
	"\x10DGRound2Message1\x12\x1d\n" +
	"\n" +
	"paillier_n\x18\x01 \x01(\fR\tpaillierN\x12%\n" +
	"\x0epaillier_proof\x18\x02 \x03(\fR\rpaillierProof\x12\x17\n" +
	"\an_tilde\x18\x03 \x01(\fR\x06nTilde\x12\x0e\n" +
	"\x02h1\x18\x04 \x01(\fR\x02h1\x12\x0e\n" +
	"\x02h2\x18\x05 \x01(\fR\x02h2\"\x12\n" +
	"\x10DGRound2Message2\"(\n" +
	...
	"\x0fDGRound4MessageB\x15Z\x13tss/ecdsa/resharingb\x06proto3"

var (
	file_ecdsa_resharing_proto_rawDescOnce sync.Once
	file_ecdsa_resharing_proto_rawDescData []byte
)

func file_ecdsa_resharing_proto_rawDescGZIP() []byte {
	file_ecdsa_resharing_proto_rawDescOnce.Do(func() {
		file_ecdsa_resharing_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_ecdsa_resharing_proto_rawDesc), len(file_ecdsa_resharing_proto_rawDesc)))
	})
...
func file_ecdsa_resharing_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_ecdsa_resharing_proto_rawDesc), len(file_ecdsa_resharing_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
