...
const file_message_data_proto_rawDesc = "" +
	"\n" +
	"\x12message-data.proto\x12\x0ebinance.tsslib\x1a\x19google/protobuf/any.proto\"\xaa\x03\n" +
	...
	"\x02to\x18\x04 \x03(\v2&.binance.tsslib.MessageWrapper.PartyIDR\x02to\x12\x1c\n" +
	"\tsessionId\x18\x06 \x01(\fR\tsessionId\x12.\n" +
	"\amessage\x18\n" +
...
var (
	...
	file_message_data_proto_rawDescData []byte
)

func file_message_data_proto_rawDescGZIP() []byte {
	file_message_data_proto_rawDescOnce.Do(func() {
		file_message_data_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_message_data_proto_rawDesc), len(file_message_data_proto_rawDesc)))
	})
...
func file_message_data_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_message_data_proto_rawDesc), len(file_message_data_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
