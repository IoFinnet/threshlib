...
func TestNewParameters(t *testing.T) {
	...
	tests := []struct {
		...
		args:    args{s256, &PeerContext{}, &PartyID{}, 2, 1},
		wantErr: false,
	}, {
		name:    "Bad parameters: low partyCount",
		args:    args{s256, &PeerContext{}, &PartyID{}, 1, 1},
		wantErr: true,
	}, {
		name:    "Bad parameters: low threshold",
		args:    args{s256, &PeerContext{}, &PartyID{}, 5, 0},
		wantErr: true,
	}, {
		name:    "Bad parameters: threshold + 1 > partyCount",
		args:    args{s256, &PeerContext{}, &PartyID{}, 2, 2},
		wantErr: true,
	}, {
...
func TestNewReSharingParameters(t *testing.T) {
	...
	tests := []struct {
		...
		args:    args{s256, &PeerContext{}, &PeerContext{}, &PartyID{}, 2, 1, 3, 2},
		wantErr: false,
	}, {
		name:    "Good re-share parameters",
		args:    args{s256, &PeerContext{}, &PeerContext{}, &PartyID{}, 3, 2, 2, 1},
		wantErr: false,
	}, {
		name:    "Bad regular parameters: low partyCount",
		args:    args{s256, &PeerContext{}, &PeerContext{}, &PartyID{}, 1, 1, 3, 2},
		wantErr: true,
	}, {
		name:    "Bad regular parameters: low threshold",
		args:    args{s256, &PeerContext{}, &PeerContext{}, &PartyID{}, 5, 0, 3, 2},
		wantErr: true,
	}, {
		name:    "Bad regular parameters: threshold + 1 > partyCount",
		args:    args{s256, &PeerContext{}, &PeerContext{}, &PartyID{}, 2, 2, 3, 2},
		wantErr: true,
	}, {
		name:    "Bad re-share parameters: low newPartyCount",
		args:    args{s256, &PeerContext{}, &PeerContext{}, &PartyID{}, 3, 2, 1, 1},
		wantErr: true,
	}, {
		name:    "Bad re-share parameters: low newThreshold",
		args:    args{s256, &PeerContext{}, &PeerContext{}, &PartyID{}, 3, 2, 5, 0},
		wantErr: true,
	}, {
		name:    "Bad re-share parameters: newThreshold + 1 > newPartyCount",
		args:    args{s256, &PeerContext{}, &PeerContext{}, &PartyID{}, 3, 2, 2, 2},
		wantErr: true,
	}, {
