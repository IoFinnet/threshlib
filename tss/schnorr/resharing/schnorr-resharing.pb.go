...
const file_schnorr_resharing_proto_rawDesc = "" +
	"\n" +
	"\x17schnorr-resharing.proto\x12\x1ebinance.tsslib.eddsa.resharing\"t\n" +
	...
	"\x0fDGRound4MessageB\x17Z\x15tss/schnorr/resharingb\x06proto3"

var (
	file_schnorr_resharing_proto_rawDescOnce sync.Once
	file_schnorr_resharing_proto_rawDescData []byte
)

func file_schnorr_resharing_proto_rawDescGZIP() []byte {
	file_schnorr_resharing_proto_rawDescOnce.Do(func() {
		file_schnorr_resharing_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_schnorr_resharing_proto_rawDesc), len(file_schnorr_resharing_proto_rawDesc)))
	})
...
func file_schnorr_resharing_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_schnorr_resharing_proto_rawDesc), len(file_schnorr_resharing_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
