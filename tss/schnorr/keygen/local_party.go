...
//
// Package keygen implements threshold key generation for EdDSA and BIP-340 signatures.
// While BIP-340 is a distinct signature scheme from EdDSA, both share the same
// threshold key generation protocol as they are both Schnorr-based schemes.
// The differentiation happens during signing, where each uses its specific
// verification algorithm and curve operations.
