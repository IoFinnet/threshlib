...
// LocalPartySaveData implements tss.SaveData
var _ tss.SaveData = LocalPartySaveData{}
...
func (save LocalPartySaveData) GetShareID() *big.Int {
	return save.ShareID
}

func (save LocalPartySaveData) GetPubKeyBz() [2][]byte {
	return save.EDDSAPub.Bytes()
}
