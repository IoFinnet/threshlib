...
// NewProofWithNonce implements proofenc with a given nonce
func NewProofWithNonce(ec elliptic.Curve, pk *paillier.PublicKey, X, Y, C, x, rhox, nonce *big.Int) (*ProofMul, error) {
